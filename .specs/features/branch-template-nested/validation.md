...
| TEMPLATE-03 | Full context + `user/{dev}/{usId}-{usSlug}/{id}-{slug}` → `user/<dev>/<us-id>-<slug-of-us>/<task-id>-<slug-of-task>` | `src/shared/tasks.test.ts:73-78` — `'user/jdoe/10001-configura-o-de-ambiente/10002-nested-branch'` | ✅ PASS |
