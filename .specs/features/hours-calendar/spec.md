...
| -------------- | ----- | ----- | ------ |
| HCAL-01 | P1: See the week as a calendar | Execute | In progress (T1, T7 of T1, T7, T11) |
| HCAL-02 | P1: See the week as a calendar | Execute | In progress (T1, T7 of T1, T7, T11) |
| HCAL-03 | P1: See the week as a calendar | Execute | In progress (T1, T7 of T1, T7, T11) |
| HCAL-04 | P1: See the week as a calendar | Execute | In progress (T1, T7 of T1, T7, T11) |
| HCAL-05 | P1: See the week as a calendar | Execute | In progress (T1, T7 of T1, T7, T11) |
...
| HCAL-10 | P1: See the week as a calendar | Execute | In progress (T3, T7 of T3, T7, T11) |
...
| HCAL-18 | P1: Get to the detail and the actions | Execute | In progress (T7 of T7, T9, T11) |
| HCAL-19 | P1: Get to the detail and the actions | Execute | In progress (T6, T7 of T6, T7, T9, T11) |
| HCAL-20 | P1: Get to the detail and the actions | Execute | In progress (T7 of T7, T11) |
| HCAL-21 | P2: Read the colours and the live time | Execute | In progress (T4, T8 of T4, T8, T11) |
| HCAL-22 | P2: Read the colours and the live time | Execute | In progress (T7 of T7, T11) |
| HCAL-23 | P2: Read the colours and the live time | Execute | In progress (T5, T7 of T5, T7, T11) |
