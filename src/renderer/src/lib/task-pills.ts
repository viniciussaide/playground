/** Handoff §Semantic color usage — type pills. Colors sourced from the
 * MultiClubes ADO process (`wit/workitemtypes`, triadesolucoes/MultiClubes,
 * 2026-08-31) per TYPE-01; types the process does not define fall back to
 * neutral `muted` (TYPE-02). */
